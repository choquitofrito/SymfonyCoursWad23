...
class ExercicesVueController extends AbstractController
{
    ...
    public function exercice1(Request $req): Response
    {
        ...
        return $this->render('exercices_vue/exercice1.html.twig',
            ['prixTotal' => $prixTotal]
        );
    }
    ...
    public function exercice2(Request $req): Response
    {
        ...
        return $this->render('exercices_vue/exercice2.html.twig',
            ['prixTotal' => $prixTotal,
            'prix' => $prix,
            'tauxTva' => $tauxTva]
        );
    ...
    public function exercice2b(Request $req): Response
    {
        ...
        return $this->render('exercices_vue/exercice2b.html.twig',
            ['prix' => $prix,
            'tauxTva' => $tauxTva]
        );
    }
