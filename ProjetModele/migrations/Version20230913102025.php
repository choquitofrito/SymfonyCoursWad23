 ...
 */
final class Version20230913102025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, prix NUMERIC(10, 2) DEFAULT NULL, description LONGTEXT DEFAULT NULL, date_publication DATE DEFAULT NULL, nombre_pages INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
